...
export default class FooterSfectoria extends Component {
  render() {
    return (
      <div>
        <footer
          className="page-footer font-small text-white blue pt-5"
          style={{ backgroundColor: "#20374E", minHeight: "60vh" }}
        >
          <div className="container-fluid text-center text-md-left">
            <div className="col-md-11 mt-md-0 mt-3 p-5 d-flex justify-content-between">
              <iframe
              ...
              <div style={{ width: "15rem" }}>
                ...
                <p>
                <CiLocationOn /> 75 Rue Khaireddine Pacha, Pacha Center Building, Block C, 1st
                  floor, Office C2, Montplaisir, Tunis.
                </p>
              </div>
            </div>
